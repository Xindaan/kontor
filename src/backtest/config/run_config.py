...
def config_to_backtest_config(run_config: RunConfig):
    ...
    return BacktestConfig(
        ...
        # so "AVGCOST" silently ran as FIFO. It is now carried through, but only
        # "FIFO" is implemented: GermanTaxModel rejects any other value at
        # construction rather than running the wrong basis silently.
